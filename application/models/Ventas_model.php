...
class Ventas_model extends CI_Model
{
    ...
    public function ventas_cortes($f1,$f2)
    {
    $aaa=date('Y');
        $s = "SELECT a.num_dias,a.mes as mm,a.suc, a.tipo2,d.nombre as tipox, a.mes,c.mes as mesx, b.regional, b.superv,b.nombre as sucx,
...
order by a.mes,tipo2,b.regional,b.superv,a.suc";
        ...
        $a[$r->mes]['mesx'] = $r->mesx;
        $a[$r->mes]['mes'] = $r->mm;
        $a[$r->mes]['m'][$r->tipo2]['imagen'] = $r->tipox;
        $a[$r->mes]['m'][$r->tipo2]['tipo2'] = $r->tipo2;
        $a[$r->mes]['m'][$r->tipo2]['segundo'][$r->regional]['regional'] = $r->regional;
        $a[$r->mes]['m'][$r->tipo2]['segundo'][$r->regional]['tercero'][$r->superv]['superv'] = $r->superv;
        $a[$r->mes]['m'][$r->tipo2]['segundo'][$r->regional]['tercero'][$r->superv]['cuarto'][$r->suc]['suc']= $r->suc;
        $a[$r->mes]['m'][$r->tipo2]['segundo'][$r->regional]['tercero'][$r->superv]['cuarto'][$r->suc]['sucx'] = $r->sucx;
        $a[$r->mes]['m'][$r->tipo2]['segundo'][$r->regional]['tercero'][$r->superv]['cuarto'][$r->suc]['num_dias'] = $r->num_dias;
        $a[$r->mes]['m'][$r->tipo2]['segundo'][$r->regional]['tercero'][$r->superv]['cuarto'][$r->suc]['credito'] = $r->credito;
        $a[$r->mes]['m'][$r->tipo2]['segundo'][$r->regional]['tercero'][$r->superv]['cuarto'][$r->suc]['recarga'] = $r->recarga;
        $a[$r->mes]['m'][$r->tipo2]['segundo'][$r->regional]['tercero'][$r->superv]['cuarto'][$r->suc]['contado'] = $r->contado;
        }
