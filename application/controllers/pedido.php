...
if($clagob==null){
    ...
    function com_generar_sumit()
    {
     ...
     if($por=='sec')
     {$this->Pedido_model->agrega_pedido_det_prv_sec($this->input->post('alm'),$this->input->post('prv'),$cia);   
     }else{$this->Pedido_model->agrega_pedido_det_prv_cla($this->input->post('alm'),$this->input->post('prv'),$cia);}
  ...
  function com_generar_det_sumit()
    {
     ...
     die();
     $this->Pedido_model->agrega_pedido_det(
     $this->input->post('id_cc'),
     $this->input->post('sec'),
     $this->input->post('can'),
     $this->input->post('regalo'),
     $this->input->post('descu')
     );  
...
function pedido_far()
 ...
 function far_generar_sumit()
    {
     ...
     'suc'=>$this->input->post('suc'),'folio'=>0);   
 ...
 function far_generar_sumit_det()
    ...
    $this->Pedido_model->graba_far_pedido_det($id_cc,$codigo,$can);
