                 <div class="span12">
                     ...
                     <div class="widget blue">
                         ...
                         <?php echo form_open('examen/nuevoEnunciado_submit', array('class' => 'form-horizontal'));?>
                         
                                <div class="control-group">
                                    <label class="control-label">Enunciado</label>
                                    <div class="controls">
                                        <?php echo form_input(array('id' => 'enunciado', 'name' => 'enunciado', 'type' => 'text', 'class' => 'input-xxlarge', 'required' => 'requiered')); ?>
