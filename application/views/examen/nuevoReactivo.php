                 <div class="span12">
                     ...
                     <div class="widget blue">
                         ...
                         <?php echo form_open('examen/nuevoReactivo_submit', array('class' => 'form-horizontal'));?>
                         
                                <div class="control-group">
                                    <label class="control-label">Reactivo</label>
                                    <div class="controls">
                                        <?php echo form_input(array('id' => 'reactivo', 'name' => 'reactivo', 'type' => 'text', 'class' => 'input-xxlarge', 'required' => 'requiered')); ?>
