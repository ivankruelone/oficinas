...
?>
                 <div class="span12">
                     ...
                     <div class="widget blue">
                         ...
                         <?php echo form_open('examen/nuevaOpcion_submit', array('class' => 'form-horizontal'));?>
                         
                                <div class="control-group">
                                    <label class="control-label">Opcion</label>
                                    <div class="controls">
                                        <?php echo form_input(array('id' => 'opcion', 'name' => 'opcion', 'type' => 'text', 'class' => 'input-xxlarge', 'required' => 'requiered')); ?>
