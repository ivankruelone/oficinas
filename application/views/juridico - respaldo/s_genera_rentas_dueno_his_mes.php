...
<table class="table table-bordered table-condensed table-striped table-hover" id="tabla1">
                             <thead>
                                 ...
                                 <th style="color:black; text-align: right">Mes</th>
                             ...
                             <tbody>
                               ...
                               $l1 = anchor('juridico/s_genera_rentas_dueno_his_det/'.$r->aaa.'/'.$r->mes,$r->mesx.'</a>', array('title' => 'Haz Click aqui para ver detalle!', 'class' => 'encabezado'));    
