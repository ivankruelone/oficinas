                     ...
                     <div class="widget blue">
                         ...
                         <table class="table table-bordered table-condensed table-striped table-hover" id="tabla1">
                             ...
                             <tbody>
                                ...
                                ?>
                                <tr>
                                <td style="color:<?php echo $color?>; text-align: left"><?php echo $r->pregunta?></td>
                                <td style="color:<?php echo $color?>; text-align: left"><?php echo $r->texto?></td>
                                <td style="color:<?php echo $color?>; text-align: center"><?php echo $r->respuestaCorrecta?></td>
                                ...
                                <td style="color:<?php echo $color?>; text-align: left"><?php echo $resultado?></td>
                                </tr>
                               <?php 
