...
<!--
    ...
    function inicio()
    {
        ...
        if($testStatus == 1){
            ...
            var $url = '<?php echo base_url('test/reddin_tiempo_terminado');?>';
        ...
        function actualiza($valor){
            $.ajax({type: "POST",
                url: "<?php echo site_url(); ?>test/actualiza_reddin/", data: ({ valor: $valor}),
        ...
        function comienza(){
            ...
            $.post( "<?php echo site_url(); ?>test/reddinComienza/", { } );
            return false;
        }
