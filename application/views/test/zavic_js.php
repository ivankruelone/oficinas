...
<!--
    ...
    function inicio()
    {
        ...
        if($testStatus == 1){
            ...
            var $url = '<?php echo base_url('test/zavic_tiempo_terminado');?>';
        ...
        function actualiza($valor){
            $.ajax({type: "POST",
                url: "<?php echo site_url(); ?>test/actualiza_zavic/", data: ({ valor: $valor}),
        ...
        function comienza(){
            ...
            $.post( "<?php echo site_url(); ?>test/zavicComienza/", { } );
            return false;
        }
