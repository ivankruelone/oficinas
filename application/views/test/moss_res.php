                     ...
                     <div class="widget blue">
                         ...
                         <table class="table table-bordered table-condensed table-striped table-hover" id="tabla1">
                             ...
                             <tbody>
                               ...
                               $num=$num+1;
                               $l1 = anchor('test/test_detalle_moss/'.$r->id,$r->completo.'</a>', array('title' => 'Haz Click aqui para ver detalle!', 'class' => 'encabezado'));
                                ?>
                                <tr>
                                ...
                                <td style="color:<?php echo $color?>; text-align: center"><?php echo $r->resultado?></td>
                                </tr>
                               <?php 
