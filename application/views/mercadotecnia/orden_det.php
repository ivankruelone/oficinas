...
<?php
	$atributos = array('id' => 'agrega_det_orden_sumit');
    echo form_open('mercadotecnia/agrega_det_orden_sumit', $atributos);
    $data_costo = array(
              'name'        => 'costo',
              'id'          => 'costo',
              'value'       => '',
...
<input type="hidden" value="<?php echo $id?>" name="id" id="id" />
 ...
 <table class="table table-bordered table-condensed table-striped table-hover" id="tabla1">
                             ...
                             <tbody>
                                ...
                                $num=$num+1;
                                $l0 = anchor('mercadotecnia/sumit_orden_det_borrar/'.$r->id.'/'.$id,'BORRAR</a>', array('title' => 'Haz Click aqui para borrar!', 'class' => 'encabezado'));
                                ?> 
                                 <tr>
