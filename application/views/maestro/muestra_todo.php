                    <div class="span12">
                        ...
                        <div class="metro-nav">
                            ...
                            <div class="metro-nav-block nav-block-orange">
                                <a href="<?php echo site_url('maestro/muestra_todo_excel'); ?>" data-original-title="">
                     ...
                     <div class="widget blue">
                         ...
                         <div class="widget-title">
                          <h4>Productos por proveedor: Todos</h4>
                           <span class="tools">
                               <a href="javascript:;" class="icon-chevron-down"></a>
                           </span>
                         </div>
                         ...
                         <table class="table table-bordered table-condensed table-striped table-hover" id="tabla1">
                            <caption>Registros: <?php echo number_format($this->pagination->total_rows, 0); ?></caption>
                             <thead>
                                     <tr>
                                        <th>Id Producto</th>
                                        <th>Ean</th>
