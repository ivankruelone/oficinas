...
?>
    ...
    //productoCambio
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <?php echo form_dropdown('idLaboartorio', $laboratorios, null, 'class="span6 chzn-select" data-placeholder="Escoge un laboratorio" tabindex="1" id="idLaboratorio"'); ?>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <?php echo form_dropdown('secuencia', $secuencias, null, 'class="span6 chzn-select" data-placeholder="Escoge una secuencia" tabindex="1" id="secuencia"'); ?>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <?php echo form_dropdown('iva', $sino, null, 'class="span6 chzn-select" data-placeholder="Iva" tabindex="1" id="iva"'); ?>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <?php echo form_dropdown('servicio', $sino, null, 'class="span6 chzn-select" data-placeholder="Servicio" tabindex="1" id="servicio"'); ?>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <?php echo form_dropdown('idLinea', $linea, null, 'class="span6" data-placeholder="Escoge una linea" tabindex="1" id="idLinea"'); ?>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <?php echo form_dropdown('idSublinea', $sublinea, null, 'class="span6" data-placeholder="Escoge una sublinea" tabindex="1" id="idSublinea"'); ?>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <?php echo form_dropdown('antibiotico', $sino, null, 'class="span6 chzn-select" data-placeholder="Servicio" tabindex="1"'); ?>
                                </div>
                            </div>
