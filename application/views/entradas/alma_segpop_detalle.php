                            ...
                            <div class="widget-body">
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th style="text-align: center;">No. de Proveedor</th>
                                    ...
                                    $num=0;
	                                   foreach ($q->result()as $r){
                                        $num=$num+1;
                                        $l1 = anchor('entradas/detalle_en1/'.$r->nped, '<i class="icon-folder-open"></i>', array('title' => 'Haz Click aqui para ver detalle!', 'class' => 'encabezado'));
                                   ...
                                   ?>
                                    <tr>
                                        ...
                                        <td style="text-align: left;"><?php echo $almacen?></td>
