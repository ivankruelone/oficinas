                     ...
                     <div class="widget blue">
                         ...
                         <table class="table table-bordered table-condensed table-striped table-hover" id="tabla1">
                             ...
                             <tbody>
                                ...
                                <?php
                                foreach ($r0['m'] as $r) {
                                if($r0['f1']==$r0['mes'] and $r['regional']==$r0['f2']){
                                ...
                                <?php }
                                $l0 = anchor('entradas/facturas_gss/'.$r0['fa'].'/'.$r0['mes'].'/'.$r1['superv'],$r1['supervx'].'</a>', array('title' => 'Haz Click aqui para ver sucursales!', 'class' => 'encabezado'));
                                 ?> 
                                    <tr>
                                    <td><?php echo $r1['superv']?></td>
                                    <td><?php echo $l0?></td>
