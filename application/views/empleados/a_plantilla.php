                     ...
                     <div class="widget blue">
                         ...
                         <table class="table table-bordered table-condensed table-striped table-hover" id="tabla1">
                             <thead>
                                 ...
                                 <th style="text-align: center">Rerional</th>
                             ...
                             <tbody>
                                ...
                                $l0 = anchor('empleados/a_plantilla_sup/'.$r->regional,$r->regional.'</a>', array('title' => 'Haz Click aqui para ver Supervisores!', 'class' => 'encabezado'));
                                 ?>
                                
                                 <tr>
                                    <td style="color: gray;text-align: center;"><?php echo $l0?></td>
                                    <td style="color: gray;text-align: center;"><?php echo $r->regionalx?></td>
                                    <td style="color: gray;text-align: center;"><?php echo $r->num_superv?></td>
                               ...
                               <?php 
                               $num_superv=$num_superv+$r->num_superv;
                              ...
                              <tr>
                                    ...
                                    <td style="color: gray;text-align: center;"><?php echo number_format($num_superv,0)?></td>
