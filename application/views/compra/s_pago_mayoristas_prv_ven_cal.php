...
<table class="table table-bordered table-condensed table-striped table-hover" id="tabla1">
                             ...
                             <thead>
                                 ...
                                 <tr><th colspan="1"style="text-align: center;">Nid</th> 
                                     <th colspan="1"style="text-align: center;">Sucursal</th>
                             ...
                             $l1 = anchor('compra/s_pago_mayoristas_prv_ven_suc/'.$r['fecven'].'/'.$r['suc'],$r['sucx'].'</a>', array('title' => 'Haz Click aqui para Ver provedores!', 'class' => 'encabezado'));  
