                     ...
                     <div class="widget red">
                         ...
                         <table class="table table-bordered table-condensed table-striped table-hover" id="tabla1">
                             <thead>
                                    ...
                                    <th colspan="5" style="text-align: center;">Consultas</th>
                                    <th colspan="14" style="text-align: center;">Servicios</th>
                                    </tr>
                             ...
                             <tbody>
                               ...
                               $num=$num+1;
                               $l1 = anchor('spt/consulta_cia/'.$perini.'/'.$perfin.'/'.$r->tipo, $r->nombre.'</a>', array('title' => 'Haz Click aqui para ver el detalle!', 'class' => 'encabezado'));
                               ?>
                                ...
                                <tr>
                                <td colspan="6" style="color: blue; text-align: right;">Promedio Consultas</td>
                                <td style="text-align: right"><?php echo number_format($r->comision_promedio, 2)?></td>
                                <td colspan="12" style="color: blue; text-align: right;">Promedio Servicios</td>
                                <td style="text-align: right"><?php echo number_format($r->Comision_Servicios, 2)?></td>
                                </tr>
                                
                                <tr>
                                <td colspan="6" style="color: blue; text-align: right;">Comisi&oacute;n M&eacute;dico</td>
                                <td style="text-align: right">$<?php echo number_format($r->doctorConsultas, 2)?></td>
                                <td colspan="12" style="color: blue; text-align: right;">Comisi&oacute;n M&eacute;dico</td>
                                <td style="text-align: right">$<?php echo number_format($r->doctorServicios, 2)?></td>
                                </tr>
                                
                                <tr>
                                <td colspan="6" style="color: blue; text-align: right;">Comisi&oacute;n Fundaci&oacute;n</td>
                                <td style="text-align: right">$<?php echo number_format($r->fundacionConsultas, 2)?></td>
                                <td colspan="12" style="color: blue; text-align: right;">Comisi&oacute;n Fundaci&oacute;n</td>
                              ...
                              <tr>
                                    <td colspan="2"></td>
                                    <td colspan="5" style="text-align: center;">Consultas</td>
                                    <td colspan="2" style="text-align: center;">Certificado M&eacute;dico General</td>
                                    <td colspan="2" style="text-align: center;">Certificado M&eacute;dico Escolar</td>
                                    <td colspan="2" style="text-align: center;">Inyeccion</td>
                                    <td colspan="2" style="text-align: center;">Lavado Otico</td>
                                    <td colspan="2" style="text-align: center;">Lavado Ocular</td>
                                    <td colspan="2" style="text-align: center;">Toma Presion</td>
                                    <td></td>
                              </tr>
                              ...
                              <tr>
                              <td colspan="2" style="color:<?php echo $color?>; text-align: right">TOTAL</td>
                              <td style="color:<?php echo $color?>; text-align: right"><?php echo number_format($consultas,0)?></td>
                              <td style="color:<?php echo $color?>; text-align: right">$<?php echo number_format($consultasImp,2)?></td>
                              <td style="color:<?php echo $color?>; text-aling: right">$<?php echo number_format($promedioTicket, 2)?></td>
                              <td style="color:<?php echo $color?>; text-align: right">$<?php echo number_format($consultasTicket,2)?></td>
                              <td></td>
                              <td style="color:<?php echo $color?>; text-align: right"><?php echo number_format($cermedgen,0)?></td>
                              <td style="color:<?php echo $color?>; text-align: right">$<?php echo number_format($cermedgenImp,2)?></td>
                              <td style="color:<?php echo $color?>; text-align: right"><?php echo number_format($cermedesc,0)?></td>
                              <td style="color:<?php echo $color?>; text-align: right">$<?php echo number_format($cermedescImp,2)?></td>
                              <td style="color:<?php echo $color?>; text-align: right"><?php echo number_format($inyeccion,0)?></td>
                              <td style="color:<?php echo $color?>; text-align: right">$<?php echo number_format($inyeccionImp,2)?></td>
                              <td style="color:<?php echo $color?>; text-aling: right"><?php echo number_format($lavadoOti, 0)?></td>
                              <td style="color:<?php echo $color?>; text-aling: right">$<?php echo number_format($lavadoOtiImp, 2)?></td>
                              <td style="color:<?php echo $color?>; text-aling: right"><?php echo number_format($lavadoOcu, 0)?></td>
                              <td style="color:<?php echo $color?>; text-aling: right">$<?php echo number_format($lavadoOcuImp, 2)?></td>
                              <td style="color:<?php echo $color?>; text-aling: right"><?php echo number_format($tomapresion, 0)?></td>
                              <td style="color:<?php echo $color?>; text-aling: right">$<?php echo number_format($tomapresionImp, 2)?></td>
                              <td></td>
                              </tr>
                              
                              <tr>
                              <td colspan="3" style="color:<?php echo $color?>; text-align: right">TOTAL M&Eacute;DICOS</td>
                              <td style="color:<?php echo $color?>; text-align: right">$<?php echo number_format($doctorServicios+$doctorConsultas,2)?></td>
                              <td colspan="16"></td>
                              </tr>
                              
                              <tr>
                              <td colspan="3" style="color:<?php echo $color?>; text-align: right">TOTAL FUNDACI&Oacute;N</td>
                              <td style="color:<?php echo $color?>; text-align: right">$<?php echo number_format($fundacionConsultas+$fundacionServicios,2)?></td>
                              <td colspan="16"></td>
                              </tr>
                              
                              <tr>
                              <td colspan="3" style="color:<?php echo $color?>; text-align: right">TOTAL DE CONSULTORIOS</td>
                              <td style="color:<?php echo $color?>; text-align: right"><?php echo number_format($consultorios, 0)?></td>
                              <td colspan="16"></td>
                              </tr>
                             </tfoot>
                         </table>   
