                    <div class="span12">
                     ...
                     <div class="widget blue">
                         ...
                         <table class="table table-bordered table-condensed table-striped table-hover" id="tabla1">
                             <thead>
                                 <tr>
                                    <th colspan="4" style="text-align: center;">Sucursal</th>
                             ...
                             <tbody>
                               ...
                               $num=$num+1;
                               $l1 = anchor('spt/consulta_suc/'.$perini.'/'.$perfin.'/'.$r->suc.'/'.$r->nomina, $r->suc.' '.$r->farmacia.'</a>', array('title' => 'Haz Click aqui para ver el detalle!', 'class' => 'encabezado'));
                               ?>
                               
                                <tr>
                                <td style="text-align: center"><?php echo $num?></td>
                                <td style="text-align: left"><?php echo $l1?></td>
                                <td style="text-align: left"><?php echo $r->nomina.' '.$r->medico?></td>
                                ...
                                <tr>
                                <td colspan="7" style="color: blue; text-align: right;">Promedio Consultas</td>
                                ...
                                <tr>
                                <td colspan="7" style="color: blue; text-align: right;">Comisi&oacute;n M&eacute;dico</td>
                                ...
                                <tr>
                                <td colspan="7" style="color: blue; text-align: right;">Comisi&oacute;n Fundaci&oacute;n</td>
                              ...
                              <tr>
                              <td colspan="4" style="color:blue; text-align: right">TOTAL</td>
