        ...
        <span class="tools">
            <a href="javascript:;" class="icon-chevron-down"></a>
             ...
             <div class="widget-body">
                 ...
                 <?php
                    echo form_open('pedido/ins_prepedido_f_com');
                    echo "<br />";   
                    ...
                    <table class="table table-bordered table-condensed table-striped table-hover" id="tabla1">
                        ...
                        <th style="color:#FF9770;"><CENTER>VALIDAR</CENTER></th>
                              ...
                              <tbody>
                                ...
                                <td><?php echo anchor('pedido/aplic_ppedido_c/'.$suc.'/'.$cod, 'Aplicar'); ?></a></td>
                                <td><?php echo anchor('pedido/upd_ppedido_c/'.$suc.'/'.$cod, 'Borrar'); ?></a></td>
