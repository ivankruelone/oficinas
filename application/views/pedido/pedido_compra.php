...
<table class="table table-bordered table-condensed table-striped table-hover" id="tabla1">
                             ...
                             <tbody>
                                ...
                                $l0 = anchor('pedido/pedido_compra_detalle/'.$items['prv'].'/'.$items['id_ped'],$items['prv'].'</a>', array('title' => 'Haz Click aqui para ver productos!', 'class' => 'encabezado'));
                                    $n=$n+1;?>
                                        ...
                                        $tu4=$tu4+$u4; 
                                          $u5=$u1+$u2+$u3+$u4;
                                          $l1 = anchor('pedido/borrar_pedido/'.$items['prv'].'/'.$items['id_ped'],'borrar</a>', array('title' => 'Haz Click aqui para borrar orden!', 'class' => 'encabezado'));
                                          $u1=0;$u2=0;$u3=0;$u4=0; ?>
