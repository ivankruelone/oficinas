...
<table class="table table-bordered table-condensed table-striped table-hover" id="tabla1">
                             ...
                             <tbody>
                                ...
                                $l2= anchor('pedido/s_val_pedido_ins_det/'.$r->id,$r->id.'</a>', array('title' => 'Haz Click aqui para detalle!', 'class' => 'encabezado'));
...
<table class="table table-bordered table-condensed table-striped table-hover" id="tabla1">
                             ...
                             <tbody>
                                ...
                                $l2= anchor('pedido/s_val_pedido_det_sin_validar/'.$r1->id,$r1->id.'</a>', array('title' => 'Haz Click aqui para detalle!', 'class' => 'encabezado'));
                                $num=$num+1;
