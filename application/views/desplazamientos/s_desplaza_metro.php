                     ...
                     <div class="widget blue">
                         ...
                         <table class="table table-bordered table-condensed table-striped table-hover" id="tabla1">
                             ...
                             <tbody>
                               ...
                               $num=$num+1;
                               $l1 = anchor('desplazamientos/s_desplaza_metro_suc/'.$r->aaa.'/'.$r->mes,'Por Sucursal</a>', array('title' => 'Haz Click aqui para ver detalle!', 'class' => 'encabezado'));
                               $l2 = anchor('desplazamientos/s_desplaza_metro_pro/'.$r->aaa.'/'.$r->mes,'Por Producto</a>', array('title' => 'Haz Click aqui para ver detalle!', 'class' => 'encabezado'));
                                ?>
                                <tr>
