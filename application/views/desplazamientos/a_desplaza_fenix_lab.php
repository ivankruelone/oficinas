...
?>                         
                         <table class="table table-bordered table-condensed table-striped table-hover" id="tabla1">
                             ...
                             <tbody>
                                 ...
                                 <?php
                                $color='blue'; $color1='green';$color2='red';
                                $t1=0;$t2=0;$t3=0;$t4=0;$t5=0;$t6=0;$t7=0;$t8=0;$t9=0;$t10=0;$t11=0;$t12=0;$t13=0;
                                $num=0;
                                foreach ($q->result()as $r){
                               $num=$num+1;
                               $l1=anchor('desplazamientos/a_desplaza_fenix_lab_excel/'.$r->nlab,'Excel');
                               
                                ?>
                                <tr>
                                <td style="color:<?php echo $color?>; text-align: left"><?php echo $num?></td>
                                <td style="color:<?php echo $color?>; text-align: left"><?php echo $r->nlab?></td>
                                <td style="color:<?php echo $color?>; text-align: left"><?php echo $r->lab?></td>
...
$t13=$t13+($r->inv);
                              ...
                              <td style="color:red; text-align: right"><?php echo number_format($t13,0)?></td>
                              <td></td>
                              </tr>
                             </tfoot>
                         </table>   
