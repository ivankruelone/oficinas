                    ...
                    <div class="widget blue">
                         ...
                         <table class="table table-bordered table-condensed table-striped table-hover" id="tabla1">
                             ...
                             <tbody>
                                ...
                                $l2 = anchor('fiscal/s_cheque_banco_det_cia/s/'.$r->aaa.'/'.$r->mes.'/'.$r->cia,$r->cia);
                                //$l2 = anchor('fiscal/s_cheque_banco_det_fac/'.$r->aaa.'/'.$r->mes.'/'.$r->cia,'Detalle');
                                $l1 = anchor('fiscal/plano_submit_det_cia/'.$r->aaa.'/'.$r->mes.'/'.$r->cia,'Arc.Detalle');
                                $l0 = anchor('fiscal/plano_submit_ctl_cia/'.$r->aaa.'/'.$r->mes.'/'.$r->cia,'Arc.Control');
                                ?>
                                <tr>
