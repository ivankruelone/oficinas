                         ...
                         <table class="table table-bordered table-condensed table-striped table-hover" id="tabla1">
                             <thead>
                                 <tr>
                                     ...
                                     <th style="text-align: left">Inv Cedis</th>
                                     <th style="text-align: right">Inv Farmacia</th>
                             ...
                             <tbody>
                                ...
                                $l0 = anchor('inventario/inv_sucursal_descon_suc/'.$r->sec,'Det</a>', array('title' => 'Haz Click aqui para ver detalle!', 'class' => 'encabezado'));
                                ?>
                                <tr>
                                ...
                                <td style="color: <?php echo $color?>; text-align: right"><?php echo number_format($r->exis_suc,0)?></td>
                                </tr>
                               <?php 
                               $tinv=$tinv+$r->inv1;
                               $tinv_impo=$tinv_impo+$r->exis_suc;
