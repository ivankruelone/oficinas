                     ...
                     <div class="widget blue">
                         ...
                         <table class="table table-bordered table-condensed table-striped table-hover" id="tabla1">
                             <thead>
                                 ...
                                 <tr>
                                    ...
                                    -->
                                     ...
                                     <th style="color:gray; text-align: left">Inventario Excel</th>
                             ...
                             <tbody>
                               ...
                               $l2 = anchor('inventario/inv_excel/'.$r->tipo,'Descargar Inventario</a>', array('title' => 'Haz Click aqui para ver detalle!', 'class' => 'encabezado'));
                               if($r->tipo=='alm' || $r->tipo=='fbo' || $r->tipo=='seg' || $r->tipo=='tra'){
