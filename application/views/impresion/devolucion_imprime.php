...
$totfal=0;
                        $e.="<table border=\"1\">
                             ...
                             <tbody>";
                                ...
                                foreach ($a as $r) {
                                if($num==1){$d1=$r['descripcion']." ".$r['empaque'];$c1=$r['cantidad'];$ya=0;}
                                elseif($num==2){$d2=$r['descripcion']." ".$r['empaque'];$c2=$r['cantidad'];$ya=0;}
                                elseif($num==3){$d3=$r['descripcion']." ".$r['empaque'];$c3=$r['cantidad'];$ya=1;}
