                             ...
                             <tbody>
                                ...
                                $tot=0; $n=0;?> 
                                        ...
                                        <td style="text-align: right;"><?php echo number_format($u4,0)?></td>
                                          ...
                                          <?php
                                        $atributos = array('id' => 'cambia');
                                        echo form_open('orden/cambia', $atributos);
                                        $tu1=$tu1+$u1;
                                        $tu2=$tu2+$u2;
                                        $tu3=$tu3+$u3;
                                        $tu4=$tu4+$u4; 
                                        ...
                                        <td><?php echo form_dropdown('ca', $r['ca'], '', 'id="ca"') ;?> </td>
                                        <td><?php echo form_submit('envio', 'acepta');?></td>
                                        
                                        </tr>
                                        <input type="hidden" value="<?php echo $r['id_ped']?>" name="id_ped" id="id_ped" />
                                        <input type="hidden" value="<?php echo $r['prv']?>" name="prv" id="prv" />
                                        <input type="hidden" value="<?php echo $r['sec']?>" name="sec" id="sec" />
                                        <input type="hidden" value="<?php echo $r['clagob']?>" name="clagob" id="clagob" />
