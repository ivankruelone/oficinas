...
$(document).ready(function() {
    ...
    function envio(event)
    {
        ...
        $url = '<?php echo site_url('orden/a_orden_segpop_det_agrega_esp'); ?>';
    ...
    {
                $url = '<?php echo site_url('orden/a_mostrar_esp'); ?>';
               $.post( $url, { id_orden: $id_orden, prv:$prv }).done(function( data ) {
                
                $("#mostrar_esp").html(data);
    ...
    function actualizadatos(event)
    {
        ...
        $url = '<?php echo site_url('orden/a_busco_id_cat_esp'); ?>';
...
-->
    ...
    $('#cla').on('change', checkcla);
        ...
        function searchcla($cla,$prv)
        {
            ...
            $url = '<?php echo site_url('orden/a_busco_clave_segpop_esp'); ?>';
