...
<?php
	$atributos = array('id' => 'a_com_generar_sumit');
    echo form_open('orden/a_com_generar_sumit', $atributos);
    $data_pass = array(
              'name'        => 'pass',
              'id'          => 'pass',
              'value'       => '',
...
<table class="table table-bordered table-condensed table-striped table-hover" id="tabla1">
                             ...
                             <tbody>
                                ...
                                $l1=anchor('orden/a_orden_segpop_det/'.$r->id_orden.'/'.$r->prv,$r->id_orden);
                                $l2=anchor('orden/a_cerrar_segpop/'.$r->id_orden.'/'.$r->prv.'/'.$r->cia,'Cerrar Orden');
                                ?>
                                        <tr>
                                        <td><?php echo $num?></td>
