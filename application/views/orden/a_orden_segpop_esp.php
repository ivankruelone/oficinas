...
<?php
	$atributos = array('id' => 'a_com_generar_sumit_esp');
    echo form_open('orden/a_com_generar_sumit_esp', $atributos);
    $data_pass = array(
              'name'        => 'pass',
              'id'          => 'pass',
              'value'       => '',
...
<table class="table table-bordered table-condensed table-striped table-hover" id="tabla1">
                             ...
                             <tbody>
                                ...
                                $l1=anchor('orden/a_orden_segpop_det_esp/'.$r->id_orden.'/'.$r->prv,$r->id_orden);
                                $l2=anchor('orden/a_cerrar_segpop_esp/'.$r->id_orden.'/'.$r->prv.'/'.$r->cia,'Cerrar Orden');
                                ?>
                                        <tr>
                                        <td><?php echo $num?></td>
                                        ...
                                        <td style="text-align: left; "><?php echo $r->licita?></td>
