...
<?php echo form_open('orden/a_orden_segpop_det_agrega_esp',array('class' => 'form-horizontal', 'id' => 'forma'));
    $data_cla = array(
              'name'        => 'cla',
              'id'          => 'cla',
              'class'       => 'span2',
...
<tr>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                <?php echo form_input($data_susa2, "", 'required');?>
                                </div>
                            </div>
  ...
  <div id="mostrar_esp">
                        <table class="table table-bordered table-condensed table-striped table-hover" id="tabla1">
                             ...
                             <tbody>
                                ...
                                $l1=anchor('orden/a_orden_segpop_det_bor_esp/'.$r->id_orden.'/'.$r->prv.'/'.$r->id_detalle,'Borrar');
