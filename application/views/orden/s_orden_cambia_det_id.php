<div class="span8">
    ...
    echo form_open('orden/sumit_cambia_orden_det', $atributos);
    $data_canp = array(
              'name'        => 'canp',
              'id'          => 'canp',
              'value'       => $canp,
...
<input type="hidden" value="<?php echo $id_responsable?>" name="id_responsable" id="id_responsable" />
  <?php
	echo form_close();
  ?>
...
<input type="hidden" value="<?php echo $fecha_envio?>" name="fecha_envio" id="fecha_envio"/>
<input type="hidden" value="<?php echo $id_estado?>" name="id_estado" id="id_estado" />
<input type="hidden" value="<?php echo $id_responsable?>" name="id_responsable" id="id_responsable" />
  <?php
	echo form_close();
