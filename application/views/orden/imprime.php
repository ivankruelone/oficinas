...
<?php $texto1='Le pedimos la cantidad minima de los productos a 12 meses.<br />
...
<table class="table table-bordered table-condensed table-striped table-hover" id="tabla1">
                             ...
                             <?php $l1='<img src="'.base_url().'img/'.$imagen.'" border="0" width="100px" />';?>   
                             </tbody>
                             <tfoot>
                             <tr>
                             ...
                             <tr>
                             <td colspan="12" style="text-align:center;"><?php echo $l1?></td>
                             </tr> 
                             <tr>
                             <td colspan="12" style="text-align:center;"><?php echo $nombre?></td>
                             </tr>
                             <tr>
                             <td colspan="12" style="text-align:left;"><?php echo $texto1?></td>
                             </tr>   
                             </tfoot>
                         </table>                        
