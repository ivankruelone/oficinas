                     ...
                     <div class="widget blue">
                        ...
                        <table class="table table-bordered table-condensed table-striped table-hover" id="tabla1">
                             <thead>
                                 ...
                                 <th style="color:black; text-align: left">Estado del<br />arrendador</th>
                                 ...
                                 <th style="color:black; text-align: left">UTILIDAD<br />PROMEDIO</th>
                                </tr>
                             </thead>
                             <tbody>
                                ...
                                if($r->criterio==1){$color='blue';}elseif($r->criterio==2){$color='orange';}else{$color='red';}
                                $l1=anchor('juridico/rentas_deuda_d_rfc/'.$r->suc.'/'.$r->rfc.'/'.$r->tipo_local.'/'.$r->criterio,'Detalle');
                                
                                $num=$num+1;
                                ?> 
                                 <tr>
                                   <td style="text-align: left; color: <?php echo $color?>;"><?php echo $r->fecha_act?></td>
                                   <td style="text-align: left; color: <?php echo $color?>;"><?php echo $r->criteriox?></td>
                                   ...
                                   <td style="text-align: right; color: <?php echo $color?>;"><?php echo number_format($r->totalmn_pre,2)?></td>
                                   <td style="text-align: right; color: <?php echo $color?>;"><?php echo number_format($r->totalusd_pre,2)?></td>
                                   <td style="text-align: right; color: <?php echo $color1?>;"><?php echo number_format($r->utilidad,2)?></td>
                                  </tr>
                               <?php 
