...
foreach($a as $r)
{
    ...
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('AC'.$ini, 'COSTO DE INV.');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('AD'.$ini, 'ZONA');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('AE'.$ini, 'SUPERVISOR');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('AF'.$ini, 'REG');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('AG'.$ini, 'REGIONAL');
    
    $objPHPExcel->getActiveSheet()->getStyle('A'.$ini.':AG'.$ini)->getAlignment()->setIndent(0)
                                  ->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_DISTRIBUTED);
    $objPHPExcel->getActiveSheet()->getStyle('A'.$ini.':AG'.$ini)
                                  ->getFont()->getColor()->setARGB(PHPExcel_Style_Color::COLOR_BLUE);
...
//resul_ven, venta, costo_venta, gastos, utilidad, por_util, resul_util            
            ...
            $objPHPExcel->setActiveSheetIndex(0)->setCellValue('AC'.$ini, $r1['costo_inv']);
            $objPHPExcel->setActiveSheetIndex(0)->setCellValue('AD'.$ini, $r1['superv']);
            $objPHPExcel->setActiveSheetIndex(0)->setCellValue('AE'.$ini, $r1['supervx']);
            $objPHPExcel->setActiveSheetIndex(0)->setCellValue('AF'.$ini, $r1['reg']);
            $objPHPExcel->setActiveSheetIndex(0)->setCellValue('AG'.$ini, $r1['regx']);
...
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('X'.$ini, $t22);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Y'.$ini, $t23);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Z'.$ini, $t24);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AA'.$ini, $t25);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AB'.$ini, $t26);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AC'.$ini, $t27);        

$objPHPExcel->getActiveSheet(0)->getStyle('C'.$ini.':AD'.$ini)->getNumberFormat()->setFormatCode('#,#00.00');
$objPHPExcel->getActiveSheet(0)->getStyle('B'.$ini.':AG'.$ini)->getFont()->getColor()->setARGB(PHPExcel_Style_Color::COLOR_BLUE);
            $ini=$ini+1;
...
$objPHPExcel->getActiveSheet(0)->getStyle('A2:'.'AG'.$ini)->getFill()
