...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('C'.$num, $row->tic)
            ->setCellValue('D'.$num, $row->sec)
            ->setCellValue('E'.$num, $row->cod)
            ->setCellValue('F'.$num, $row->des)
            ->setCellValue('G'.$num, $row->cant)
            ->setCellValue('H'.$num, $row->lin)
            ->setCellValue('I'.$num, $row->imp)
            ->setCellValue('J'.$num, $row->nombre)
;
