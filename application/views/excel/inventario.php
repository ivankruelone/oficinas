...
$num = 5;
$sql = "SELECT t.tipo_producto, s.subtipo_producto, p.clave, p.descripcion, p.unidad, sum(i.inv) as inv, preorden, min, max, i.lote, i.caducidad
FROM inventario i
...
where activo=1
group by p.id
order by p.tipo_producto, s.subtipo_producto, p.clave + 0;";
