...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('K'.$ini, 'Lote')
            ->setCellValue('K'.$ini, 'Caducidad')
;            

$num = 5;
$sql = "SELECT t.tipo_producto, s.subtipo_producto, p.clave, p.descripcion, p.unidad, sum(i.inv) as inv, preorden, min, max, i.lote, i.caducidad FROM inventario i
...
and activo=1
group by p.clave, i.lote, i.caducidad
