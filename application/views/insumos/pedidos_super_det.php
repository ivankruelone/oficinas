...
<?php
	echo form_open('insumos/inserta_ins_super');
    $data_can = array(
              'name'        => 'can',
              'id'          => 'can',
              'value'       => '',
...
?>
 ...
 $l1 = anchor('insumos/pedidos_superins_delete/'.$id_cc.'/'.$r2->id,'Borrar</a>', array('title' => 'Haz Click aqui para borrar!', 'class' => 'encabezado'));
                                         $num=$num+1;?>
                                        <tr>
