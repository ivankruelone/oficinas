...
<table class="table table-bordered table-condensed table-striped table-hover" id="tabla1">
  ...
  if($r2->canp>$r2->sur){$bgcolor='orange';}else{$bgcolor='blue';}                                        
                                        ...
                                        <td style="text-align: left; color: <?php echo $bgcolor ?>"><?php echo $r2->nomina?></td>
                                        <td style="text-align: left; color: <?php echo $bgcolor ?>"><?php echo $r2->completo?></td>
                                        <td style="text-align: left; color: <?php echo $bgcolor ?>"><?php echo $r2->sucx?></td>
                                        <td style="text-align: left; color: <?php echo $bgcolor ?>"><?php echo $r2->puestox?></td>
                                        ...
                                        <td style="text-align: right; color: <?php echo $bgcolor ?>"><?php echo number_format(($r2->canp*$r2->costo),2)?></td>
