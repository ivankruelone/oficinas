...
<table class="table table-bordered table-condensed table-striped table-hover" id="tabla0">
  ...
  $l1 = anchor('insumos/s_insumos_det/'.$r1->id_cc.'/'.$r1->fol.'/'.$id_comprar,'Detalle</a>', array('title' => 'Haz Click aqui para Ver Detalle!', 'class' => 'encabezado'));
  $l2 = anchor('insumos/s_insumos_det_excel/'.$r1->id_cc.'/'.$r1->fol.'/'.$id_comprar, '<i class="icon-save"></i>Excel', array('class' => 'btn btn-success btn-app'));
...
<!---->
 ...
 <!-- END BLANK PAGE PORTLET-->   
                     ...
                     <div class="widget blue">
                         ...
                         <div class="widget-body">
<?php 
$l0 = anchor('insumos/s_insumos_imp_p/'.$id_comprar,'imprime_previos</a>', array('title' => 'Haz Click aqui para cerrar folio!', 'class' => 'encabezado'));
?>
<table class="table table-bordered table-condensed table-striped table-hover" id="tabla1">
  ...
  $l1 = anchor('insumos/s_insumos_det/'.$r2->id_cc.'/'.$r2->fol.'/'.$id_comprar,'Detalle</a>', array('title' => 'Haz Click aqui para Ver Detalle!', 'class' => 'encabezado'));
  $l2 = anchor('insumos/s_insumos_det_excel/'.$r2->id_cc.'/'.$r2->fol.'/'.$id_comprar, '<i class="icon-save"></i>Excel', array('class' => 'btn btn-success btn-app'));
  if($r2->fol>'A'){$color='orange';}else{$color='black';}
                                         $num=$num+1;?>
                                        <tr>
                                        <td style="text-align: left; color: <?php echo $color ?>"><?php echo $num?></td>
