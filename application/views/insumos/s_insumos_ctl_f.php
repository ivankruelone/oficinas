...
<table class="table table-bordered table-condensed table-striped table-hover" id="tabla3">
  ...
  $l2 = anchor('insumos/s_insumos_det_f_excel/'.$r3->id_cc.'/'.$r3->suc, '<i class="icon-save"></i>Excel', array('class' => 'btn btn-success btn-app'));
                                        ...
                                        <tr>
                                        <td style="text-align: left; color: <?php echo $color ?>"><?php echo $num?></td>
                                        <td style="text-align: left; color: <?php echo $color ?>"><?php echo $r3->id_cc?></td>
                                        ...
                                        <td style="text-align: right; color: <?php echo $color ?>"><?php echo number_format($r3->ped,0)?></td>
                                        <td style="text-align: right; color: <?php echo $color ?>"><?php echo number_format($r3->sur,0)?></td>
