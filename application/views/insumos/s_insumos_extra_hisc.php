 ...
 <table class="table table-bordered table-condensed table-striped table-hover" id="tabla1">
  ...
  //$l1 = anchor('insumos/insumos_extra_imp/'.$r2->id.'/'.$r2->fol,'Imprime</a>', array('title' => 'Haz Click aqui para Imprimir !', 'class' => 'encabezado'));
    $l1 = anchor('insumos/s_insumos_extra_hisc2/'.$r2->id.'/'.$r2->fol,'Detalles</a>', array('title' => 'Haz Click aqui para Buscar empleados!', 'class' => 'encabezado'));
