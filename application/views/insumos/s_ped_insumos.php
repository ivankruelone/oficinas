...
<?php 
$l0 = anchor('insumos/insert_ctl_insumo','<font size="+2">Agrega nuevo pedido de insumos</font></a>', array('title' => 'Haz Click aqui para agregar pedidos de insumos!', 'class' => 'encabezado'));
?>
<table class="table table-bordered table-condensed table-striped table-hover" id="tabla1">
  ...
  $l1 = anchor('insumos/s_ped_insumos_det/'.$r2->id,'Detalle</a>', array('title' => 'Haz Click aqui para Ver Detalle!', 'class' => 'encabezado'));
                                         $num=$num+1;?>
                                        <tr>
