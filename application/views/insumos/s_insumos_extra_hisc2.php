 ...
 <table class="table table-bordered table-condensed table-striped table-hover" id="tabla1">
  ...
  $l1 = anchor('insumos/insumos_extra_imp/'.$r2->id.'/'.$r2->fol.'/'.$r2->nomina,'Imprime</a>', array('title' => 'Haz Click aqui para Imprimir !', 'class' => 'encabezado'));
                                        ...
                                        <td style="text-align: left; color: <?php echo $color ?>"><?php echo $r2->nomina?></td>
                                        <td style="text-align: left; color: <?php echo $color ?>"><?php echo $r2->completo?></td>
                                        <td style="text-align: left; color: <?php echo $color ?>"><?php echo $r2->puestox?></td>
