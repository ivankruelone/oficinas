                     ...
                     <div class="widget blue">
                         ...
                         <table class="table table-bordered table-condensed table-striped table-hover" id="tabla1">
                             ...
                             <tbody>
                                ...
                                <?php
                               foreach ($r0['m'] as $r) {
                                $l0 = anchor('ventas/s_ventas_cortes_suc/'.$r0['mes'].'/'.$r['tipo2'],str_pad($r0['mes'],2,'0',STR_PAD_LEFT).' '.$r['imagen'].'</a>', array('title' => 'Haz Click aqui para ver sucursales!', 'class' => 'encabezado'));
