                         ...
                         <table class="table table-bordered table-condensed table-striped table-hover" id="tabla">
                             <thead>
                                ...
                                <th colspan="10">REPORTE DE VENTAS SIN CREDITO Y SIN RECARGAS</th>
                                 ...
                                 <tr>
                                     ...
                                     <th style="text-align: right; color: green;">% DE ALCANCE<br />REAL SIN IVA</th>
                                 </tr>
                             ...
                             <tbody>
                               ...
                               ?>
                                ...
                                <tr>
                                <td style="color: maroon;"><?php echo $num?></td>
                                <td style="color: maroon;"><?php echo $r->dia?></td>
                                ...
                                <td style="text-align: right; color: blueviolet;"><?php echo'% '.number_format($r->porce,2)?></td>
                                ...
                                $porce=($t04/$t05)*100;
                                if($t06>0){$porce_real=($t06/$t05)*100;}
                                ?>
