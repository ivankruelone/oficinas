                     ...
                     <div class="widget blue">
                         ...
                         <table class="table table-bordered table-condensed table-striped table-hover" id="tabla1">
                             <thead>
                                 <tr>
                                    ...
                                    <th style="text-align: center">Mes</th> 
                                     ...
                                     <th style="text-align: center">Venta Sucrsal</th> 
                             ...
                             <tbody>
                                ...
                                $l0=anchor('ventas/s_depositos_det/'.$r->aaa.'/'.$r->mes,$r->mesx.'</a>', array('title' => 'Haz Click aqui para Ver provedores!', 'class' => 'encabezado'));    
                               ?>
