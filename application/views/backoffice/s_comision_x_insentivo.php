...
<table class="table table-bordered table-condensed table-striped table-hover" id="tabla1">
                             ...
                             <tbody>
                                ...
                                $num=$num+1;
                                //if($r->mes==(date('m')-1)){
                                $l0 = anchor('comision/comision_insentivo/'.$r->aaa.'/'.str_pad($r->mes,2,"0",STR_PAD_LEFT).'/'.$r->dias,$r->mesx.'</a>', array('title' => 'Haz Click aqui para ver sucursales!', 'class' => 'encabezado'));
                                //}else{
                                //$l0=$r->mesx;    
                                //}
                                ?> 
