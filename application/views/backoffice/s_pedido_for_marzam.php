...
<?php
$l1 = anchor('backoffice/graba_for_pedido','Grabar pedido</a>', array('title' => 'Haz Click aqui para Ver Sucursal!', 'class' => 'encabezado'));
?>                           
                         </div>
 ...
 <table class="table table-bordered table-condensed table-striped table-hover" id="tabla1">
                             ...
                             <tbody>
                                 <?php
                                 $num=0;$margen=0;$color='gray';$color1='gray';$tot=0;
                                ...
                                <?php $tot=$tot+$r->importe; } ?> 
                              </tbody>
                              <tfoot>
                              <tr>
                              <td colspan="5" style="color:<?php echo $color?>;text-align: right;"><?php echo number_format($tot,2)?></td>
                              <td></td>
                              </tr>
                              </tfoot>
                         </table>
