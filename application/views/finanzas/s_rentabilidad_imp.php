...
<?php $lx='<img src="'.base_url().'img/logo.png" border="0" width="190px" />';?>
       <table>
                            ...
                            <tr>
                                     ...
                                     <th style="text-align: center;">% Utilidad</th>
                                     <th style="text-align: center;">Monto por<br />Cada sucursal</th>
    ...
    <?php  $color='blue';$num=1;$tot1=0;$tot2=0;$tot3=0;$tot4=0;$tot5=0;$utilidad_40=0;$gasto_oficina_tot=0;
                                     foreach ($q1->result() as $r1) {
                                       $mas_gasto=(($r1->gas_x_suc)*($r1->num_suc))+$r1->gastos;
                                       $utilidad_40=$r1->venta-(+$r1->costo_venta+$mas_gasto);
                                       $gasto_oficina_tot=$r1->gasto_oficina_tot;
                                        ?>
                                        <tr style="border: 1px solid #000;">
                                        <td style="width: auto; text-align: left; color: <?php echo $color ?>"><?php echo $num?></td>
                                        <td style="width: auto; text-align: left; color: <?php echo $color ?>"><?php echo $r1->aaa?></td>
                                        <td style="width: 50px; text-align: left; color: <?php echo $color ?>"><?php echo $r1->mesx?></td>
                                        <td style="width: auto; text-align: right; color: <?php echo $color ?>"><?php echo number_format($r1->num_suc,0)?></td>
                                        ...
                                        <td style="width: 100px; text-align: right; color: <?php echo $color ?>"><?php echo number_format($r1->gastos,2)?></td>
                                        <td style="width: 100px; text-align: right; color: <?php echo $color ?>"><?php echo number_format($r1->utilidad,2)?></td>
                                        <td style="width: 100px; text-align: right; color: <?php echo $color ?>"><?php echo '%'.number_format($r1->p_utilidad,2)?></td>
                                        <td style="width: auto; text-align: right; color: <?php echo $color ?>"><?php echo number_format($r1->gas_x_suc,2)?></td>
                                        <td style="width: auto; text-align: right; color: <?php echo $color ?>"><?php echo number_format($utilidad_40,2)?></td>
                                        <td style="width: auto; text-align: right; color: <?php echo $color ?>"><?php echo number_format((($utilidad_40/$r1->venta)*100),2)?></td>
